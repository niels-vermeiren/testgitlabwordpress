...
<div class="pt-info-box pt-style-1">
   ...
   <div class="pt-info-call">
      <i class="<?php echo esc_attr($settings['number_icon']['value']) ?>"></i>
      <h4 class="cpt-call-number"><?php echo esc_html($settings['title_number']);?></h4>
   </div>
