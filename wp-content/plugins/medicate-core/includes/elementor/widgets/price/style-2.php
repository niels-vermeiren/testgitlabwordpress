...
?>
<div class="pt-pricing-plan pt-style-2 <?php echo esc_attr($align); ?>">
            <span class="pt-title"><?php echo esc_html($settings['title']); ?></span>
            <div class="price">
                <span class="pt-price-dollar"><?php echo esc_html($settings['price_currency']); ?></span>
                <span class="pt-amount"><?php echo esc_html($settings['price']); ?></span>
