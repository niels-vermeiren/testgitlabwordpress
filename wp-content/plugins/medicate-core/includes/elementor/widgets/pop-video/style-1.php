...
if($settings['PV_style'] == '1')
 { ?>
<div class="pt-popup-video-block <?php echo esc_attr($settings['text_align']); ?>">
	<?php 
	if (!empty($settings['img']['url'])) {
    $imge_url .= $settings['img']['url']; ?>
    <img class="pt-popup-img" src="<?php echo esc_url($imge_url); ?>" alt="popup">
    <?php } ?>
