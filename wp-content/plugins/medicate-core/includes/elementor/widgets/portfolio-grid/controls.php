...
class Portfolio_grid extends Widget_Base {
	...
	public function get_name() {
		return __( 'portfolio-grid', 'medicate' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_sliderwerwe',
			[
				'label' => __( 'portfolios', 'medicate' ),
			]
		);
		$this->add_control(
			'show_filter',
			[
				'label' => __( 'Show Filter-bar', 'medicate' ),
	...
	$this->add_control(
			'hide_load_more',
			[
				'label' => __( 'Hide Load More', 'medicate' ),
				'type' => Controls_Manager::SWITCHER,
...
$this->add_control(
			'grid_style',
				[
					'label' => __( 'Grid Style', 'medicate' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'pt-col-3',
					'options' => [
						'pt-col-6'  => __( 'Two Column', 'medicate' ),
						'pt-col-4'  => __( 'Three Column', 'medicate' ),
						'pt-col-3'  => __( 'Four Column', 'medicate' ),
					],

					'selectors' => [
						'{{WRAPPER}} .pt-button' => 'border-style: {{VALUE}};',
	...
	$this->add_control(
			'initial_items',
			[
				'label' => __( 'Number Item To Show', 'medicate' ),
	...
	$this->add_control(
			'next_items',
			[
				'label' => __( 'Number Of Item To Load', 'medicate' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 1,
				'step' => 1,
				'default' => 5,
