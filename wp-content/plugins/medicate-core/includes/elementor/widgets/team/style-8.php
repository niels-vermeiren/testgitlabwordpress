...
if ($settings['team_style'] === '8')
{
    ?>
    <div class="pt-team pt-team-style-4 ">
        <?php
           ...
           ?>
              <div class="pt-team-box pt-style-4">
                 <div class="pt-team-img">
                    ...
                    <span class="pt-team-work-since"><?php echo esc_html($item['work_text']); ?></span> 
                </div>
            </div>
     <?php } ?>
</div>
