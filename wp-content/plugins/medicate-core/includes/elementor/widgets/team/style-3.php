...
if ($settings['team_style'] === '3')
{
    ...
    ?>
    <div class="pt-team pt-team-style-2 ">
       <div class="owl-carousel" <?php echo $this->get_render_attribute_string('slider'); ?>>
        ...
        foreach ( $tabs as $index => $item )
        {
           ...
           ?>
           <div class="item">
            <div class="pt-team-box pt-style-2">
            <div class="pt-team-img">
             ...
             <div class="pt-team-info">
                 <h5 class="pt-member-name">
                    <a <?php echo $this->get_render_attribute_string('btn_attr'.$index); ?> ><?php echo esc_html($item['title_text']); ?>
                    </a>
                </h5>
