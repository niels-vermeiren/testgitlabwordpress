...
class Portfolioslider extends Widget_Base {

	public function get_name() {
		return __( 'portfolio slider', 'medicate' );
	}
	...
	protected function register_controls() {
		 ...
		 $this->add_control(
		  ...
		  $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pt-portfoliobox-1 .pt-portfolio-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .pt-portfoliobox-1 .pt-portfolio-icon i' => 'color: {{VALUE}};',
				 		],
...
Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Portfolioslider() );