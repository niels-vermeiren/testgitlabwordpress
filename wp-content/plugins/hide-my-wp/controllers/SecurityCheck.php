...
class HMWP_Controllers_SecurityCheck extends HMWP_Classes_FrontController
{
    ...
    public function action()
    {
        ...
        case 'hmwp_frontendcheck':
            ...
            $url = site_url() . '/' . $pluginsPath . '/' . $hmwpPath . '/view/assets/img/logo.png?hmwp_preview=1&hmwp_brokenfiles=0&test=' . mt_rand(11111,99999);
            ...
            if (!is_wp_error($response) ) {
                ...
                if (wp_remote_retrieve_response_code($response) == 200 ) {
                    ...
                    if (HMWP_Classes_Tools::$default['hmwp_wp-json'] <> HMWP_Classes_Tools::getOption('hmwp_wp-json') ) {
                        $url = site_url() . '/' . HMWP_Classes_Tools::getOption('hmwp_wp-json') . '?hmwp_preview=1' ;
                        $response = HMWP_Classes_Tools::hmwp_localcall($url, array('cookies' => false, 'redirection' => 0));
